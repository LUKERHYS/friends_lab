...
def test_remove_name_of_friend
...
def test_money_loan
  ...
  assert_equal(51, @person1[:monies]) #money recieved
  assert_equal(50, @person5[:monies]) #money leant
end

  # 8. Find the set of everyone's favourite food joined together
  # (hint: concatenate the favourites/snack arrays together)
  def test_fav_foods
    result = fav_foods(@people)
